...
% well, just for test in easy case
code = 3;
if code == 1
    x0 = x_01;
    y0 = y_01;
...
%             state_predict(1:3) = state_predict(1:3) - hebel_b;
            P = diag(state_var);
            %
...
figure
subplot(3,1,1)
plot(pos_ohnearm(1,:) - pos_mitarm(1,:))
title('x')
set(gca,'FontSize', 20);
subplot(3,1,2)
plot(pos_ohnearm(2,:) - pos_mitarm(2,:))
title('y')
set(gca,'FontSize', 20);
subplot(3,1,3)
plot(pos_ohnearm(3,:) - pos_mitarm(3,:))
title('z')
set(gca,'FontSize', 20);